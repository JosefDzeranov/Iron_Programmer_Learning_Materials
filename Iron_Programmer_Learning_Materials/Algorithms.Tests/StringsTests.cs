...
{
    internal sealed class StringsTests
    {
        ...
        public void Levenshtein_OneStringEmpty_LengthSecondStringReturned()
        {
            ...
            // Act
            var levenshtein1 = Strings.Strings.Levenshtein(s, t);
            var levenshtein2 = Strings.Strings.Levenshtein(t, s);

            // Assert
            Assert.AreEqual(expected.Distance, levenshtein1.Distance, $"Levenshtein distance should be {expected.Distance}, but it is {levenshtein1.Distance}.");
            Assert.AreEqual(expected.Distance, levenshtein2.Distance, $"Levenshtein distance should be {expected.Distance}, but it is {levenshtein2.Distance}.");
        }
        ...
        public void Levenshtein_EqualStrings_ZeroReturned()
        {
            ...
            // Act
            var actual1 = Strings.Strings.Levenshtein(s, t);
            var actual2 = Strings.Strings.Levenshtein(t, s);
